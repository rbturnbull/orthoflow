def test_alignment_summary(run_workflow):
    w = run_workflow("results/supermatrix/alignment_summary.cds.txt")
...
def test_supermatrix_ascii(run_workflow):
    w = run_workflow("results/supermatrix/supermatrix_tree_ascii.cds.txt")
...
def test_supermatrix_render(run_workflow):
    w = run_workflow("results/supermatrix/supermatrix_tree_render.cds.svg")
